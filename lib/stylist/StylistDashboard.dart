  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          await fetchBookingDataId(id);
          await fetchBookingDataIdFrequentUserId(id);
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    ClientsDetails(
                                                      token: widget.token,
                                                      userId:
                                                          bookingdata.userId.id,
                                                    )));
                                      },
                                      child: bookingdata
                                              .userId.profileImg.isEmpty
                                          ? Container(
                                              width: 82,
                                              height:
...
class LoadingEff extends StatelessWidget {
  const LoadingEff({
    super.key,
  });
...
class Skelent extends StatelessWidget {
  const Skelent({
    super.key,
    this.height,
    this.width,
